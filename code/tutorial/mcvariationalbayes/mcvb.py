...
from .torchjson import *
import mcvariationalbayes.modelcomparison as modelcomparison 
...
class TensorContainer(object):
    ...
    def json_dumps(self, *args, **kwargs):
        return dumps(self._named_buffers, *args, **kwargs)

    def json_dump(self, *args, **kwargs):
        return dump(self._named_buffers, *args, **kwargs)

    def json_loads(self, *args, **kwargs):
        self._named_buffers = loads(*args, **kwargs)
        return self
    
    def json_load(self, *args, **kwargs):
        self._named_buffers = load(*args, **kwargs)
        return self
